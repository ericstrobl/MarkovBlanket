function [Ranked,KCDM] = BackCDm(x,TarIndx,kernel_type,reg)
...
%     (default='rbf')
% (4) reg = regularization value (default=1E-2 for linear kernel, 1E-4 for
%     rbf kernel)
% 
% Outputs:
...
SetDefaultValueK(4,'reg',kernel_type);
...
for t1=1:c-2, 
    ...
    for t=toTest,
        ...
        Ky = KernelType(dotT+doty,kernel_type);
        Gy = Q*(Ky)*Q;
